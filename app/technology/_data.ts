...
export const CORE_STACK: Technology[] = [
  {
    ...
    intro:
      "Next.js is the React framework we standardize every Vizantir build on. Every site we ship runs on the same modern foundation, from a small studio brand to a multi-location operation. We chose it because it solves the problems that hold most websites back: slow page loads, fragile plugin dependencies, and a CMS that gets in the editor's way.",
    whyWeUseIt: [
  ...
  },
  {
    ...
    whyWeUseIt: [
      'Editors get a focused workspace built around your content model instead of a 90-extension WordPress dashboard.',
  ...
  },
  {
    ...
    description:
      'Vizantir deploys every site to Vercel, with a global edge network, zero-config Next.js hosting, and instant rollbacks.',
    intro:
  ...
  },
  {
    ...
    description:
      "Vizantir builds every site in TypeScript. It's typed JavaScript that catches bugs before they ship and keeps the codebase readable as it grows.",
    intro:
...
export const SPECIALIZED_TOOLS: Technology[] = [
  {
    ...
    businessOutcome:
      "Most websites stop at \"here's information.\" Supabase is what lets a Vizantir site become something more, such as a client portal, a member directory, a booking system, or an internal tool. We bring it in when the project calls for it, not by default. When it's needed, it cuts custom backend work by 80%.",
  },
  {
    slug: 'stripe',
    name: 'Stripe',
    ...
    description:
      'Vizantir integrates Stripe for websites that need to accept payments, including subscriptions, one-time charges, and customer portals.',
    intro:
  ...
  },
  {
    ...
    description:
      'Vizantir integrates Resend for transactional email, including contact forms, password resets, order confirmations, and anything else your site needs to send.',
    intro:
      "Resend is the email infrastructure we use when a Vizantir build needs to send transactional email such as contact form submissions, welcome emails, password resets, and order confirmations. It's a modern email platform built by developers who got tired of the legacy options. The reason we use it: emails actually arrive, deliverability is genuinely good, and the developer experience cuts integration time from days to hours.",
    whyWeUseIt: [
    ...
    businessOutcome:
      "Most websites that send email are doing it wrong. They use Gmail SMTP, get flagged as spam, and lose leads that never knew the contact form went through. Resend means every email your site sends actually arrives. That's the difference between a contact form that generates inquiries and a contact form that quietly drops 30% of them into spam folders.",
  },
  {
    slug: 'cloudflare',
    name: 'Cloudflare',
    ...
    businessOutcome:
      "Most sites don't think about network-layer security until something goes wrong, like a DDoS, a credential-stuffing attack, or a sudden traffic spike. By then it's too late. Cloudflare in front of your site means these problems are handled before they ever reach your application. You don't notice it working, which is exactly the point.",
  },
  {
    slug: 'gsap',
    name: 'GSAP',
  ...
  },
  {
    ...
    description:
      'Vizantir uses Framer Motion for component-level React animations, including entrances, hover states, page transitions, and gesture-driven interactions.',
    intro:
      "Framer Motion is the animation library we use within React components for page transitions, scroll-in fades, hover micro-interactions, and gesture-driven UI. It's declarative and component-aware, which means animations live alongside the components they animate rather than in separate animation scripts. This makes the codebase cleaner and changes safer.",
    whyWeUseIt: [
      'Declarative API. Animations are described as props on components, not orchestrated separately.',
      'Built specifically for React. It works naturally with component state, mounting, and unmounting.',
    ...
    businessOutcome:
      "A site without thoughtful micro-interactions feels static. A site with too much animation feels exhausting. Framer Motion is the tool that lets us place animation precisely where it serves the visitor, whether that is a card fading in as it scrolls into view, a button responding to hover, or a page transition that feels considered rather than abrupt. The animations you don't consciously notice are the ones doing the most work.",
  },
  {
    slug: 'analytics',
    name: 'Analytics',
    ...
    description:
      'Vizantir integrates Google Analytics or Vercel Analytics on every site, giving you accurate visitor data without compromising performance or privacy.',
    intro:
    ...
    whyWeUseIt: [
      'Vercel Analytics is first-party analytics with no cookie banner required, automatically integrated with the Vercel platform, and perfect for marketing-focused sites.',
      'Google Analytics 4 is industry-standard visitor analytics with deep integration into other Google marketing tools (Search Console, Ads, Looker Studio).',
  ...
  },
  {
    ...
    description:
      'Vizantir integrates Microsoft Clarity for visual behavior analytics, including heatmaps, session recordings, and rage-click detection on every page.',
    intro:
      "Microsoft Clarity is the qualitative analytics tool we install on every Vizantir build that wants to understand visitor behavior visually. Heatmaps show where visitors click and scroll. Session recordings let you watch how real users navigate your site. It's free, privacy-conscious, and adds nearly zero performance overhead. We pair it with Google Analytics or Vercel Analytics so you get quantitative data on one side and qualitative on the other.",
    whyWeUseIt: [
      "Heatmaps reveal where visitors actually click, which is often very different from where you'd expect.",
